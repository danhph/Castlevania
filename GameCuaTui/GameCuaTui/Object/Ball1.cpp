...
Ball1::Ball1(int x, int y) :BaseObject(BALL1)
{
...
void Ball1::draw(LPD3DXSPRITE spriteHandle, Viewport* viewport)
{
...
RECT Ball1::getBounding()
{
	return _sprite->getBounding();
}

float Ball1::checkCollision(BaseObject* object, float dt)
{
