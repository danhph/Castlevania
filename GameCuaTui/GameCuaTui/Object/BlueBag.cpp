...
BlueBag::BlueBag(int x, int y) :BaseObject(BLUEBAG)
{
...
void BlueBag::draw(LPD3DXSPRITE spriteHandle, Viewport* viewport)
{
	_sprite->render(spriteHandle, viewport);
}

void BlueBag::update(float deltatime)
{
...
RECT BlueBag::getBounding()
{
	return _sprite->getBounding();
}

float BlueBag::checkCollision(BaseObject* object, float dt)
{
