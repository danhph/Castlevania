...
PotRoast::PotRoast(int x, int y) :BaseObject(POTROAST)
{
...
void PotRoast::draw(LPD3DXSPRITE spriteHandle, Viewport* viewport)
{
	_sprite->render(spriteHandle, viewport);
}

void PotRoast::update(float deltatime)
{
...
RECT PotRoast::getBounding()
{
	return _sprite->getBounding();
}

float PotRoast::checkCollision(BaseObject* object, float dt)
{
