...
WhipUpgrade::WhipUpgrade(int x, int y) :BaseObject(WHIPUPGRADE)
{
...
void WhipUpgrade::draw(LPD3DXSPRITE spriteHandle, Viewport* viewport)
{
...
RECT WhipUpgrade::getBounding()
{
	return _sprite->getBounding();
}

float WhipUpgrade::checkCollision(BaseObject* object, float dt)
{
