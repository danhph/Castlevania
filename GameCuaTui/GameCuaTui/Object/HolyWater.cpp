...
HolyWater::HolyWater(int x, int y) :BaseObject(HOLYWATER)
{
...
void HolyWater::draw(LPD3DXSPRITE spriteHandle, Viewport* viewport)
{
...
RECT HolyWater::getBounding()
{
	return _sprite->getBounding();
}

float HolyWater::checkCollision(BaseObject* object, float dt)
{
