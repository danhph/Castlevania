...
BlueBat::BlueBat(int x, int y, int activeX) : BaseObject(BLUEBAT)
{
	...
	_activeXRight = x;
	_animation->addFrameRect(eID::ENEMY, "blue_bat_1", "blue_bat_2", "blue_bat_3", "blue_bat_4",NULL);
...
void BlueBat::wasHit(int hitpoint)
{
	if (!_startHit)
	{
		_hitPoint -= hitpoint;
